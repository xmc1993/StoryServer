...
import cn.edu.nju.software.vo.UserBaseFollowBabyVo;
...
public class UserFollowController {
	...
	@ResponseBody
	public ResponseData<Boolean> follow(@ApiParam("被关注者ID") @RequestParam("followeeId") int followeeId,
	...
	@ResponseBody
	public ResponseData<Boolean> unfollow(@ApiParam("需要取消关注者ID") @RequestParam("followeeId") int followeeId,
			HttpServletRequest request, HttpServletResponse response) {
		ResponseData<Boolean> responseData = new ResponseData<>();
		User user = (User) request.getAttribute(TokenConfig.DEFAULT_USERID_REQUEST_ATTRIBUTE_NAME);
		if (user == null) {
	...
	@ResponseBody
	public ResponseData<List<UserBaseFollowBabyVo>> getFollowerListByUserId(
			@ApiParam("用户ID") @RequestParam("userId") Integer userId, @ApiParam("OFFSET") @RequestParam int offset,
			@ApiParam("LIMIT") @RequestParam int limit, HttpServletRequest request, HttpServletResponse response) {
		ResponseData<List<UserBaseFollowBabyVo>> responseData = new ResponseData<>();
		User user = (User) request.getAttribute(TokenConfig.DEFAULT_USERID_REQUEST_ATTRIBUTE_NAME);
		if (user == null) {
		...
		ArrayList<UserBaseFollowBabyVo> result = new ArrayList<>();
	...
	@ResponseBody
	public ResponseData<List<UserBaseFollowBabyVo>> getFolloweeListByUserId(
			@ApiParam("用户ID") @RequestParam("userId") int userId, @ApiParam("OFFSET") @RequestParam int offset,
			@ApiParam("LIMIT") @RequestParam int limit, HttpServletRequest request, HttpServletResponse response) {
		ResponseData<List<UserBaseFollowBabyVo>> responseData = new ResponseData<>();
		User user = (User) request.getAttribute(TokenConfig.DEFAULT_USERID_REQUEST_ATTRIBUTE_NAME);
		if (user == null) {
	...
	@ResponseBody
	public ResponseData<Integer> getFollowingStatus(@ApiParam("用户ID") @RequestParam("userId") int userId,
			HttpServletRequest request, HttpServletResponse response) {
