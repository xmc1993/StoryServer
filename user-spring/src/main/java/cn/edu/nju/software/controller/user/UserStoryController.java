...
public class UserStoryController extends BaseController {
    ...
    @ApiOperation(value = "根据故事Id获取故事简介(如果没有故事简介放回故事内容)", notes = "")
    @RequestMapping(value = "/getStoryIntroductionById", method = {RequestMethod.GET})
    @ResponseBody
    public ResponseData<String> getStoryIntroductionById(@ApiParam("故事ID") @RequestParam("id") Integer id) {
