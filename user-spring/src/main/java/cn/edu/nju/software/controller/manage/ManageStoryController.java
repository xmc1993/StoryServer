...
public class ManageStoryController {
    ...
    public ResponseData<StoryNewVo> publicStory(
        ...
        if (originSoundFile != null && !originSoundFile.isEmpty()) {
            ...
            String duration = storyService
                    .getOriginSoundLength(new File(UploadFileUtil.getRealPathFromUrl(story.getOriginSoundUrl())));
    ...
    @ResponseBody
    public StoryNewVo updateStoryTag(@ApiParam("故事ID") @PathVariable int id,
                                     @ApiParam("故事标题") @RequestParam(value = "title", required = false) String title,
                                     @ApiParam("作者") @RequestParam(value = "author", required = false) String author,
                                     @ApiParam("内容") @RequestParam(value = "content", required = false) String content,
                                     @ApiParam("出版社") @RequestParam(value = "press", required = false) String press,
        ...
        if (originSoundFile != null && !originSoundFile.isEmpty()) {
            if (story.getOriginSoundUrl() != null)
    ...
    public ResponseData<Boolean> deleteCover(@ApiParam("故事ID") int id, @ApiParam("要清除的字段") String query,
                                             HttpServletRequest request, HttpServletResponse response) {
    ...
    @ResponseBody
    @ResponseStatus(HttpStatus.NO_CONTENT)
    public void deleteStory(@ApiParam("故事ID") @PathVariable int id, HttpServletRequest request,
    ...
    @ResponseBody
    public ResponseData<List<Story>> getAllStories(@ApiParam("OFFSET") @RequestParam int offset,
    ...
    @ResponseBody
    @ResponseStatus(HttpStatus.NO_CONTENT)
    public void recommendStory(@ApiParam("故事ID") @PathVariable int id) {
    ...
    @ResponseBody
    @ResponseStatus(HttpStatus.NO_CONTENT)
    public void cancelRecommendStory(@ApiParam("故事ID") @PathVariable int id) {
    ...
    @ResponseBody
    public String testPut(@ApiParam("OFFSET") @RequestParam int offset, @ApiParam("LIMIT") @RequestParam int limit) {
    ...
    public ResponseData<List<StoryNewVo>> getStoryByFuzzyQuery(
        ...
        List<Story> stories = storyService.getStoryByClassifyFuzzyQueryIncludeDrafts(title, author, content, press, tag,
                offset, limit);
        if (stories == null) {
            ...
            result.setCount(
                    storyService.getStoryCountByClassifyFuzzyQueryIncludeDrafts(title, author, content, press, tag));
            return result;
        }
    }
    ...
    @ResponseBody
    public ResponseData<List<Story>> getStoryByFuzzyQuery(@ApiParam("offset") @RequestParam("offset") int offset,
    ...
    @ResponseBody
    public ResponseData<List<StoryTitleVo>> getStoryByFuzzyQuery() {
        ResponseData<List<StoryTitleVo>> result = new ResponseData<>();
        List<StoryTitleVo> storyTitleList = storyService.getAllStoryTitle();
    ...
    private StoryNewVo story2vo(Story story) {
        ...
        // 设置故事集
        if (0 != story.getSetId()) {
            StorySet storySet = storySetService.getStorySetById(story.getSetId());
            storyVo.setStorySet(storySet);
        }
