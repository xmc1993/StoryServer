...
public class ManageStorySetController {
    ...
    public StorySet publishStorySet(
            @ApiParam("故事集") @RequestBody StorySet storySet,
    ...
    @ResponseBody
    public StorySet updateStorySet(
    ...
    @ResponseBody
    public StorySet getStorySetById(
            @ApiParam("ID") @PathVariable int id,
            HttpServletRequest request, HttpServletResponse response) {
    ...
    @ResponseBody
    public StorySet getStorySetByStoryId(
    ...
    public void recommendStory(
            @ApiParam("故事集ID") @PathVariable int id) {
