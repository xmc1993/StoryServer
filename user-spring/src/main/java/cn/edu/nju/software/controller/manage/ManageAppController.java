...
public class ManageAppController {
	...
	@ResponseBody
	public ResponseData<Boolean> publishApp(@ApiParam("版本") @RequestParam("version") String version,
			@ApiParam("更新信息") @RequestParam("updateHint") String updateHint,
			@ApiParam("App") @RequestParam(value = "appFile") MultipartFile appFile, HttpServletRequest request,
	...
	@ResponseBody
	public ResponseData<Boolean> updateApp(@ApiParam("appId") @RequestParam(value = "appId") int appId,
